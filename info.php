...
?>
    ...
    <button class="button button2" onclick="clik()">Show Data</button><button class="button button2" id="exp">Export Data</button>
    ...
    <div class="col-md-3">  
          ...
          <input type="checkbox" id="RollNumber" name="RollNumber" value="Bike" onclick="functions(id)" >
